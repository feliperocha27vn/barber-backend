...
describe('Update service use case', () => {
  beforeEach(() => {
    ...
    sut = new UpdateServiceBarberShopUseCase(
      servicesBarberShopRepository,
      barberShopRepository
    )
  })

  it('deve garantir que o serviço seja atualizado', async () => {
    ...
    expect(service).toEqual(
      expect.objectContaining({ nome: 'Corte de Cabelo Atualizado' })
    )
  })
})
